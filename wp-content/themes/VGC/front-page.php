						        ...
						        <ul class="products-grid  first last odd">
						            <li class="item first">
						                ...
						                <div class="box-feature">
						                    <h2 class="product-name"><a href="detail.html" title="Jewelry Name">Jewelry Name</a></h2>
											<div class="price-box">
												    ...
												    <div class="box-item home">
												        <div class="products">
												            <article class="product">
												                <figure>
												                    <a href="detail.html" title="Voluptas nulla" class="product-image">
												        ...
												        <h2 class="product-name">
												        	<a href="detail.html" title="Jewelry Name">Jewelry Name</a>
											        	</h2>
												...
												<li class="col-md-4 col-sm-4 col-sms-12 item first">
										            <div class="item-inner">
										                ...
										                <div class="box-item">
										                    <h2 class="product-name"><a href="detail.html" title="Jewelry Name">Jewelry Name</a></h2>
															<div class="price-box">
										                        <span class="regular-price" id="product-price-18"><span class="price">$86.00</span></span>
															</div>
															<div class="actions">
										                        <div class="cart-content">
										                            <button type="button" class="button btn-cart" rel="tooltip" data-original-title=""><span><span>+ Add to Cart</span></span></button>
										                        </div>
										                    </div>
										                </div>
										            </div>
												...
												<li class="col-md-4 col-sm-4 col-sms-12 item first">
										            <div class="item-inner">
										                ...
										                <div class="box-item">
										                    <h2 class="product-name"><a href="detail.html" title="Jewelry Name">Jewelry Name</a></h2>
															<div class="price-box">
										                        <span class="regular-price" id="product-price-21"><span class="price">$98.00</span> </span>
															</div>
															<div class="actions">
										                        <div class="cart-content">
										                            <button type="button" class="button btn-cart" rel="tooltip" data-original-title=""><span><span>+ Add to Cart</span></span>													                            </button>
