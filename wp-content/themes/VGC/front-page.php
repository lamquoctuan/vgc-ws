                        ...
                        <div class="ma-banner8-container">
                            <div class="flexslider">
                                ...
                                <div class="flex-viewport">
                                    <ul class="slides">
                                        <li><img src="<?php echo TEMP_URI; ?>/assets/images/banner8/bg2-banner8.jpg"
                                                 alt=""></li>
                                        <li><img src="<?php echo TEMP_URI; ?>/assets/images/banner8/bg-banner8.jpg"
                                                 alt=""></li>
                                        <li><img src="<?php echo TEMP_URI; ?>/assets/images/banner8/bg1-banner8.jpg"
                                                 alt=""></li>
                                    </ul>
                                </div>
                            </div>
