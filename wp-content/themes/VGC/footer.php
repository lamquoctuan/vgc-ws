		...
		<div class="container">
			<div class="footer-static row">
				...
				<div class="f-col f-col4 col-sm-6 col-md-3 col-sms-6 col-smb-12">
					...
					<div class="footer-static-content">
						<div class="f-social">
							<a href=""><img src="<?php echo TEMP_URI;?>/assets/images/icon-tw.png" /></a>
							<a href=""><img src="<?php echo TEMP_URI;?>/assets/images/icon-lk.png" /></a>
							<a href=""><img src="<?php echo TEMP_URI;?>/assets/images/icon-fb.png" /></a>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="footer">
				<div class="row">
					<div class="col-xs-12 col-sm-6">
						<address>Copyright © 2015 <a href="#">VGC</a>. All rights Reserved.</address>
					</div>
					<div class="col-xs-12 col-sm-6">
						<div class="box-footer">
							<div class="f-images">
								<img src="<?php echo TEMP_URI;?>/assets/images/paypal.png" />
							</div>
						</div>
					</div>
				</div>
