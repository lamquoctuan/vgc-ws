            ...
            <ul class="form-list">
                ...
                <li class="fields">
                    ...
                    <div class="field">
                        ...
                        <div class="input-box">
                            <select id="region_id" name="region_id" title="State/Province" class="validate-select required-entry" defaultvalue="0">
...
<!--                            <script type="text/javascript">
        ...
        <div class="buttons-set">
            ...
            <p class="back-link"><a href="account-dashboard.html"><small>« </small>Back</a>
            </p>
            <button type="submit" title="Save Address" class="button"><span><span>Save Address</span></span>
            </button>
        </div>
    </form>
    <!--<script type="text/javascript">
